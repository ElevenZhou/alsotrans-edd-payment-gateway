...
class ATPConfig {
    ...
    public function __construct($config = array(), $mode = 'live') {
    ...
    public function getGateway() {
        return $this->getUrl('gateway');
    }

    public function getPaymentMethodUrl() {
        return $this->getUrl('paymentMethodUrl');
    }

    public function getPaymentCurrencyUrl() {
        return $this->getUrl('paymentCurrencyUrl');
    }
